 ...
 * email-only payloads. The controller forwards it untouched; WhitelistService.add()
 * parses it (defaulting to PROFESSOR when absent) and validates it is
 * PROFESSOR/GESTOR — the whitelist never grants ADMIN.
 */
